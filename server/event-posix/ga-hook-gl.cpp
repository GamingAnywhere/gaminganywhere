...
static void gl_hook_symbols()
{
	...
	// for hooking
	old_glFlush = (t_glFlush)ga_hook_lookup_or_quit(handle, "glFlush");
...
void glFlush() { hook_glFlush(); }

__attribute__((constructor)) static void gl_hook_loaded(void)
{
