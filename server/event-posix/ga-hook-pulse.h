...
extern "C"
{
	...
	typedef int (*t_pa_simple_write)(pa_simple* s, const void* data, size_t bytes, int* error);
	// async
	typedef pa_stream* (*t_pa_stream_new)(pa_context* c, const char* name, const pa_sample_spec* ss, const pa_channel_map* map);
	...
	typedef void (*t_pa_stream_set_write_callback)(pa_stream* p, pa_stream_request_cb_t cb, void* userdata);
