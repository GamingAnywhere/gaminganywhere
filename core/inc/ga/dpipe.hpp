...
typedef struct dpipe_s {
	...
	//
	std::mutex cond_mutex;	/**< pthread mutex for conditional signaling */
	std::condition_variable cond;		/**< pthread condition */
	//
	std::mutex io_mutex;	/**< dpipe i/o pool operation mutex */
