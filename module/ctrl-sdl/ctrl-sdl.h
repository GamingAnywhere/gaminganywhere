...
#define GEN_KB_ADD_FUNC_PROTO(type, field) int sdlmsg_kb_add_##field(type v, int remove)
...
#define GEN_KB_MATCH_FUNC_PROTO(type, field) int sdlmsg_kb_match_##field(type v)
