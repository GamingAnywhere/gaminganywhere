...
class QoSAC3AudioRTPSink : public AC3AudioRTPSink
{
  ...
  protected:
	QoSAC3AudioRTPSink(UsageEnvironment& env, Groupsock* RTPgs, u_int8_t rtpPayloadFormat, u_int32_t rtpTimestampFrequency);
	~QoSAC3AudioRTPSink();
};
...
{
  public:
	static QoSSimpleRTPSink* createNew(UsageEnvironment& env,
												  Groupsock* RTPgs,
  ...
  protected:
	QoSSimpleRTPSink(UsageEnvironment& env,
						  Groupsock* RTPgs,
						  unsigned char rtpPayloadFormat,
						  unsigned rtpTimestampFrequency,
						  char const* sdpMediaTypeString,
...
{
  public:
	static QoSVorbisAudioRTPSink* createNew(UsageEnvironment& env,
														 Groupsock* RTPgs,
														 u_int8_t rtpPayloadFormat,
														 u_int32_t rtpTimestampFrequency,
														 unsigned numChannels,
  ...
  protected:
	QoSVorbisAudioRTPSink(UsageEnvironment& env,
								 Groupsock* RTPgs,
								 u_int8_t rtpPayloadFormat,
								 u_int32_t rtpTimestampFrequency,
								 unsigned numChannels,
...
{
  public:
	static QoSTheoraVideoRTPSink* createNew(UsageEnvironment& env,
														 Groupsock* RTPgs,
														 u_int8_t rtpPayloadFormat,
														 u_int8_t* identificationHeader,
														 unsigned identificationHeaderSize,
  ...
  protected:
	QoSTheoraVideoRTPSink(UsageEnvironment& env,
								 Groupsock* RTPgs,
								 u_int8_t rtpPayloadFormat,
								 u_int8_t* identificationHeader,
								 unsigned identificationHeaderSize,
...
{
  public:
	static QoSH264VideoRTPSink* createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat);
	static QoSH264VideoRTPSink* createNew(UsageEnvironment& env,
													  Groupsock* RTPgs,
													  unsigned char rtpPayloadFormat,
													  u_int8_t const* sps,
													  unsigned spsSize,
  ...
  protected:
	QoSH264VideoRTPSink(UsageEnvironment& env,
							  Groupsock* RTPgs,
							  unsigned char rtpPayloadFormat,
...
{
  public:
	static QoSH265VideoRTPSink* createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat);
	static QoSH265VideoRTPSink* createNew(UsageEnvironment& env,
													  Groupsock* RTPgs,
													  unsigned char rtpPayloadFormat,
													  u_int8_t const* vps,
													  unsigned vpsSize,
  ...
  protected:
	QoSH265VideoRTPSink(UsageEnvironment& env,
							  Groupsock* RTPgs,
							  unsigned char rtpPayloadFormat,
...
{
  public:
	static QoSVP8VideoRTPSink* createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat);
