...
extern "C"
{
	...
	JNIEXPORT jboolean JNICALL Java_org_gaminganywhere_gaclient_GAClient_initGAClient(JNIEnv* env,
																												 jobject thisObj,
																												 jobject weak_this);
	...
	JNIEXPORT void JNICALL Java_org_gaminganywhere_gaclient_GAClient_sendMouseMotion(JNIEnv* env,
																												...
																												jint state,
																												jboolean relative);
	JNIEXPORT void JNICALL Java_org_gaminganywhere_gaclient_GAClient_sendMouseWheel(JNIEnv* env,
																											  jobject thisObj,
																											  jint dx,
																											  jint dy);
	// GL
	JNIEXPORT void JNICALL Java_org_gaminganywhere_gaclient_GAClient_GLresize(JNIEnv* env,
																									  jobject thisObj,
																									  jint width,
																									  jint height);
